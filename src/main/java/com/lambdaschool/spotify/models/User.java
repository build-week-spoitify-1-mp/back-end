        ...
        extends Auditable
{
    ...
    @JsonIgnoreProperties(value = "user",
            allowSetters = true)
    private List<com.lambdaschool.spotify.models.Useremail> useremails = new ArrayList<>();
    ...
    @JsonIgnoreProperties(value = "user",
            allowSetters = true)
    private List<com.lambdaschool.spotify.models.UserRoles> roles = new ArrayList<>();
    ...
    public User(
            ...
            String password,
            String primaryemail,
            List<com.lambdaschool.spotify.models.UserRoles> userRoles)
    {
        setUsername(username);
        setPassword(password);
        setPrimaryemail(primaryemail);
        for (com.lambdaschool.spotify.models.UserRoles ur : userRoles)
        {
            ur.setUser(this);
        }
     ...
     */
    public List<com.lambdaschool.spotify.models.Useremail> getUseremails()
    {
        return useremails;
    }
     ...
     */
    public void setUseremails(List<com.lambdaschool.spotify.models.Useremail> useremails)
    {
