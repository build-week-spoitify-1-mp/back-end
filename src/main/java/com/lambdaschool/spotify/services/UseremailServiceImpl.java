...
import com.lambdaschool.spotify.repositories.UseremailRepository;
...
public class UseremailServiceImpl
        implements com.lambdaschool.spotify.services.UseremailService
{
    /**
     ...
     */
    @Autowired
    private com.lambdaschool.spotify.services.UserService userService;
